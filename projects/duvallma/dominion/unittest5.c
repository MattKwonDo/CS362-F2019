...
// set variables
int card = 8; //comes from array above
int choice1 = 1;
int choice2 = 2;
int choice3 = 4;
int handPos = 0;
int bonus = 0;
int tempEstateCount = state->supplyCount[estate] - 1;
...
// assert that the supply count is as expected
	assert(G>supplyCount[estate] == tempEstateCount); 
